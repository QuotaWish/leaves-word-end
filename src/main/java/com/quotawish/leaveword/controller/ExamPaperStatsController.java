...
import com.quotawish.leaveword.service.impl.ExamPaperStatsImpl;
...
*/
    @Autowired
    private ExamPaperStatsImpl examPaperStatsServiceImpl;
    ...
    */
    ...
    return examPaperStatsServiceImpl.getById(id);
    }
